<div class="row">
    <div class="col-12 col-sm-10 col-xl-6 mx-md-auto my-4">
        <form method="post" action="/biblioteca/libros/editar.php">
            <div class="card rounded-top border-dark bg-transparent">
                <div class="card-title bg-naranja p-3 rounded-top mb-0">
                    <h1 class="mb-0"><i class="bi bi-book me-2 fs-1"></i>Editar libro</h1>
                </div>
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="titulo" class="form-label">
                                        <i class="bi bi-bookmark-check me-2"></i>Título
                                    </label>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input name="editorial" type="text" value="<?= $libro['editorial'] ?>" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <!--genero-->
                                <div class="col">
                                    ...
                                    <select class="form-select" aria-label="Género" name="genero">
                                        <option value="<?= $libro['genero'] ?>" selected>Género</option>
                                        <?php
                                ...
                                <div class="col">
                                    ...
                                    <input name="anhoPublicacion" min="1000" max="2999" type="number"
                                        value="<?= $libro['anhoPublicacion'] ?>" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input name="isbn" type="text" value="<?= $libro['isbn'] ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col">
                                    ...
                                    <select class="form-select" multiple placeholder="Autores" size="14"
                                        ...
                                        foreach ($autores as $autor) {
                                            ...
                                            echo '<option value="' . $autor['idAutor'] . '"selected>' . $nombreAutor . '</option>';
                                        }
                                        ?>
                                    </select>
